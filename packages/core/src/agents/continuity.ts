...
description 中要明确引用 hook_id，并把状态列中 stale / blocked 的原文标记字面抄进去。本维度只审结构，不评价伏笔文笔。`;
    ...
    case 38:
      return language === "en"
        ? "Check atmosphere and mood: Does the chapter create a distinct sensory environment? Are there moments of quiet beauty, tension, or wonder that elevate the prose beyond plot mechanics? Look for: (1) Environmental details that evoke emotion, (2) Pacing that allows moments to breathe, (3) Imagery that lingers in the reader's mind. A chapter that moves events forward but lacks atmosphere reads as mechanical."
        : "检查意境营造：本章是否创造了独特的感官环境？是否有静谧之美、紧张之感、惊奇之境，让文字超越情节机制？检查：(1)环境细节是否引发情感共鸣，(2)节奏是否允许场景呼吸，(3)意象是否在读者脑海中留有余韵。只推进事件但缺乏意境的章节读起来像机械运转。";
    case 39:
      return language === "en"
