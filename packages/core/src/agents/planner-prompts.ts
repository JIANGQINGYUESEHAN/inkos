...
1. 节奏周期灵活：5-8 章为一个小目标周期，10-20 章为一个大叙事弧线。允许 3-5 章纯铺垫期（蓄势阶段），厚积薄发比密集爽点更重要
...
6. 爽点节奏：小爽点可在 3-5 章内兑现，大爽点需要 10-20 章铺垫。不要为了密集爽点牺牲叙事深度
7. 高潮前铺垫：大高潮前 5-8 章必须有线索埋设，让读者有"原来如此"的恍然感
8. 高潮后影响：爆发章之后 2-3 章必须写出改变（主线推进、人设成长、关系变化），不要急于进入下一个蓄压
9. 人物立体化：核心标签 + 反差细节 = 活人
10. 五感具体化：场景描写必须有具体可视化感官细节
11. 钩子承接：每章章尾留钩
12. 钩子账本必须结账：每章对活跃 hook 做明确动作（open/advance/resolve/defer），允许"新开一堆不回收"
...
> phaseIndex：本章在"当前小目标周期（5-8章）"中是第几章。第1章铺基础，中间章推进或转折，倒数第2-3章为高潮铺垫，最后1章为爆发/兑现。plan时根据上一章的phaseIndex推算本章处于周期的哪个位置。
>
> 节奏建议：
> - phaseIndex 1-2：铺世界观/新信息/新阻力，此时不应兑现任何核心 hook
> - phaseIndex 3-5：推进支线，埋新钩子，核心 hook 在此阶段应有至少 1 次 advance
> - phaseIndex 6-7：收线，缩小悬念范围，为爆发章积蓄压力
> - phaseIndex 8：爆发/兑现/回收，至少 1 个核心 hook 在此章 resolve 或大幅 advance。写完后 cycle 重置
...
- goal 字段不超过 50 字
- phaseIndex 必须为 1-8，从上章 phaseIndex+1 推算（phaseIndex 到达 8 后下章重置为 1）
...
1. Flexible rhythm: 5-8 chapters per small-goal cycle, 10-20 chapters per major narrative arc. Allow 3-5 chapters of pure buildup (accumulation phase) — slow-burn is more valuable than cramming payoff beats. Every cycle must close with at least one hook resolved or dramatically advanced.
...
> phaseIndex: which chapter this is within the current mini-goal cycle (5-8 chapters). Ch1 lays foundation, middle chapters advance or pivot, second-to-last chapters prep for climax, last chapter delivers payoff. Calculate from the previous chapter's phaseIndex.
>
> Rhythm guidance:
> - phaseIndex 1-2: lay world/conflict foundation, no hook resolution yet
> - phaseIndex 3-5: advance subplots, plant new hooks, at least 1 core hook advance
> - phaseIndex 6-7: narrow suspense, prepare for payoff chapter
> - phaseIndex 8: deliver/payoff/resolve — at least 1 core hook resolves or dramatically advances. Cycle resets after
---
...
- phaseIndex must be 1-8, calculated from previous chapter's phaseIndex + 1 (reset to 1 after phaseIndex 8)
